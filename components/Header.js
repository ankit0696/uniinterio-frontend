...
export default function Header() {
  return (
    <Popover className='relative bg-rose-50'>
      <div className='flex justify-between items-center px-4 py-6 sm:px-6 md:justify-start md:space-x-10'>
        <div className='flex justify-start lg:w-0 lg:flex-1'>
          <a href='#'>
            <span className='sr-only'>Uni Interio</span>

            <img className='h-12 w-auto sm:h-16' src='/uniinterio.svg' alt='' />
          </a>
        </div>
        ...
        <div className='hidden md:flex items-center justify-end md:flex-1 lg:w-0'>
          ...
          <a
            href='#'
            className='ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-full shadow-sm text-base font-medium text-white bg-rose-600 hover:bg-rose-700'
          >
            Consult Now
          </a>
        </div>
